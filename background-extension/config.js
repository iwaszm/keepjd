...
export const PAGE_DELAY_MIN_MS = 100;
export const PAGE_DELAY_MAX_MS = 1000;
...
export const UPLOAD_RETRY_DELAY_MIN_MS = 60000;
export const UPLOAD_RETRY_DELAY_MAX_MS = 180000;
