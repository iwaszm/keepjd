...
export const FORBIDDEN_COOLDOWN_BASE_MINUTES = 5;
export const FORBIDDEN_COOLDOWN_MAX_AUTO_RESUMES = 5;
export const FORBIDDEN_PROBE_URL = "https://www.joybuy.de/";
export const FORBIDDEN_PROBE_TIMEOUT_MS = 20000;
